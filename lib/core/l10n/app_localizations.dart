...
/// Phase 7 adds local audio discussion without changing earlier translations.
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'retryMessages': 'Retry',
      'voicePlaceholder': 'Voice recording requires an Android device',
      // Phase 7: the same composer and page discussion support local audio.
      'audioRecord': 'Record voice message',
      'audioRecording': 'Recording',
      'audioPaused': 'Recording paused',
      'audioPreview': 'Preview voice message',
      'audioReplacePreview': 'Preview replacement',
      'audioPauseRecording': 'Pause recording',
      'audioResumeRecording': 'Resume recording',
      'audioStopRecording': 'Stop recording',
      'audioCancelRecording': 'Discard recording',
      'audioSend': 'Send voice message',
      'audioReplace': 'Replace your recording',
      'audioDelete': 'Delete your recording',
      'audioPlay': 'Play',
      'audioPausePlayback': 'Pause playback',
      'audioResumePlayback': 'Resume playback',
      'audioStopPlayback': 'Stop playback',
      'audioPermissionDenied': 'Microphone permission denied',
      'audioPauseUnsupported': 'Pause requires Android 7 or later; recording continues.',
      'audioMessageError': 'Could not record or save voice message',
      'audioLocalReader': 'Local reader',
    ...
    'ar': {
      ...
      'voicePlaceholder': 'يتطلب تسجيل الصوت جهاز Android',
      'audioRecord': 'تسجيل رسالة صوتية',
      'audioRecording': 'جارٍ التسجيل',
      'audioPaused': 'التسجيل متوقف مؤقتًا',
      'audioPreview': 'معاينة الرسالة الصوتية',
      'audioReplacePreview': 'معاينة الصوت البديل',
      'audioPauseRecording': 'إيقاف التسجيل مؤقتًا',
      'audioResumeRecording': 'استئناف التسجيل',
      'audioStopRecording': 'إيقاف التسجيل',
      'audioCancelRecording': 'التخلّص من التسجيل',
      'audioSend': 'إرسال الرسالة الصوتية',
      'audioReplace': 'استبدال تسجيلك',
      'audioDelete': 'حذف تسجيلك',
      'audioPlay': 'تشغيل',
      'audioPausePlayback': 'إيقاف التشغيل مؤقتًا',
      'audioResumePlayback': 'استئناف التشغيل',
      'audioStopPlayback': 'إيقاف التشغيل',
      'audioPermissionDenied': 'رُفض إذن الميكروفون',
      'audioPauseUnsupported': 'يتطلب الإيقاف المؤقت Android 7 أو أحدث؛ التسجيل مستمر.',
      'audioMessageError': 'تعذّر تسجيل الرسالة الصوتية أو حفظها',
      'audioLocalReader': 'قارئ محلي',
