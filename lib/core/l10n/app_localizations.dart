...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'hostLanIpExample': 'Host LAN IP (e.g. 192.168.1.50)',
      ...
      'invalidIp': 'Invalid Host IP. Please enter a valid LAN IP like 192.168.1.50.',
    ...
    'ar': {
      ...
      'hostLanIpExample': 'عنوان المضيف (مثال 192.168.1.50)',
      ...
      'invalidIp': 'عنوان المضيف غير صالح. أدخل عنوان LAN صحيح مثل 192.168.1.50.',
